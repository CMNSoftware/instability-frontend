    ...
    return (
        <View style={styles.background}>
            <SafeAreaView style={styles.container}>
                <View >
                    <Text style={[styles.title]}>Kararsız</Text>
                </View>
                <View>
                ...
                <View style={styles.board}>
                    <View>
                        ...
                        />
                        <Icon name="user-alt" size={15} style={{ position: 'absolute', left: 45, top: 30, color: '#FF4B26' }} />
                    </View>
                    <View>
                        <TextInput
                        ...
                        />
                        <Icon name="lock" size={15} style={{ position: 'absolute', left: 45, top: 20, color: '#FF4B26' }} />
                    </View>
                </View>
                <View>
